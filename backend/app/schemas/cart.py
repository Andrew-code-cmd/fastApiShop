...
class CartItemBase(BaseModel):
    ...
    quantity: int = Field( ..., gt=0, description='Quantity (must be greate than 0)') 
...
class CartItem(BaseModel): # поля для каждого товара
    product_id: int
...
class CartResponse(BaseModel): # общий список товаров 
